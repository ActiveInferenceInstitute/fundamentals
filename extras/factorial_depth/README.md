...
Run any non-interactive script with `--save` to render artifacts under `output/figures/extras/factorial_depth/` and raw-data sidecars under `output/data/extras/factorial_depth/`.
