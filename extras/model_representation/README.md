...
How internal representations stand in for hidden causes.
...
- `visualize_model_representation.py` - visualize orchestrator over `active_inference.extra_topics` and core APIs.
